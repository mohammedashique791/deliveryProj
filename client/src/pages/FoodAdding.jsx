        ...
        <div>
            <form onSubmit={foodAdding}>
                <div className="mt-10 flex flex-col gap-5">
                    ...
                    <div className="border p-4 mandan rounded-xl flex w-[1200px] justify-center hover:translate-x-10">
                        <input value={isavailable} onChange={(ev) => setisAvailable(ev.target.value)} type="text" placeholder="available or not" />
                    </div>
                    <div className="border p-4 mandan bg-fonzzi rounded-2xl flex w-[1150px] justify-center hover:translate-x-10">
